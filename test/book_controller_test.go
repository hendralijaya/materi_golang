...
func TestCreateBookSuccess(t *testing.T) {
	...
	assert.Equal(t, "Eko Kurniawan Khannedy", responseBody["data"].(map[string]interface{})["author"])
}
...
func TestCreateFailed(t *testing.T) {
	...
	assert.Equal(t, "Author", responseBody["errors"].([]interface{})[0].(map[string]interface{})["key"])
...
func TestUpdateSuccess(t *testing.T) {
	...
	assert.Equal(t, "Success", responseBody["status"])
	assert.Equal(t, "Belajar Golang Bersama Programmer Zaman Now", responseBody["data"].(map[string]interface{})["title"])
	assert.Equal(t, "Eko Kurniawan", responseBody["data"].(map[string]interface{})["author"])
}
...
func TestFindAllSuccess(t *testing.T) {
	...
	assert.Equal(t, "Eko Kurniawan Khannedy", responseBody["data"].([]interface{})[0].(map[string]interface{})["author"])
}
